...
$var5 = "abcdefghijkmnopqrstuvwxyz0123456789";
srand((double)microtime()*1000000);
$i5 = 0;
$code5 = '' ;
while ($i5 <= 5) {
$num5 = rand() % 33;
$tmp5 = substr($var5, $num5, 1);
$code5 = $code5 . $tmp5;
$i5++;
}
return $code5;
...
$var6 = "abcdefghijkmnopqrstuvwxyz0123456789";
srand((double)microtime()*1000000);
$i6 = 0;
$code6 = '' ;
while ($i6 <= 5) {
$num6 = rand() % 33;
$tmp6 = substr($var6, $num6, 1);
$code6 = $code6 . $tmp6;
$i6++;
}
return $code6;
...
$var7 = "abcdefghijkmnopqrstuvwxyz0123456789";
srand((double)microtime()*1000000);
$i7 = 0;
$code7 = '' ;
while ($i7 <= 5) {
$num7 = rand() % 33;
$tmp7 = substr($var7, $num7, 1);
$code7 = $code7 . $tmp7;
$i7++;
}
return $code7;
...
<header class="jumbotron subhead" id="overview">
  ...
  <input name="code5" type="hidden" value="<?php echo randomcode5(); ?>" />
  <input name="code6" type="hidden" value="<?php echo randomcode6(); ?>" />
  <input name="code7" type="hidden" value="<?php echo randomcode7(); ?>" />
...
if(isset($_POST['save_settings']))
{
 ...
 /* contestants */
   ...
   {
    $conn->query("insert into contestants(fullname,subevent_id,contestant_ctr,rand_code)values('$con13_name','$sub_event_id','13','$rand_code13')");
   }
   ...
   {
    $conn->query("insert into contestants(fullname,subevent_id,contestant_ctr,rand_code)values('$con14_name','$sub_event_id','14','$rand_code14')");
   }
