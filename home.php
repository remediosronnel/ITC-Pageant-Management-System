          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
             ...
             <li>
              ...
              <li>
                  <a href="#" onclick="deleteAllData(event)">Delete All Data</a>
              </li>
...
<header class="jumbotron subhead" id="overview" style="margin: 0; padding: 0;">
  <div class="container" style="display: flex; align-items: center; justify-content: space-between; margin: 0; padding: 0;">
    <div style="margin: 0; padding: 0;">
      <h1 style="margin: 0; padding-left: 100px;">List of Events</h1>
...
window.location = 'home.php';					
   ...
   <?php include('footer.php'); ?>
    ...
    <script>
      async function deleteAllData(e) {
        e.preventDefault();
        ...
        try {
          ...
          const res = await fetch('delete_all.php', {
            method: 'POST',
