        ...
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
               ...
               <a class="brand" href="#"><img src="uploads/<?php echo $company_logo; ?>" width="23" height="23" />&nbsp; <font size="3">Pageant Management System</font></a>
...
<td>
  <div style="display: flex; justify-content: space-between; align-items: center;">
    <div>
      ...
      <h4 style="color: whitesmoke !important;">Pageant Management System</h4>
    </div>
    <div style="margin-left: auto; padding-right: 200px;">
      <img src="img/ms_itcnoback.png" alt="Right Logo" style="width: 100px;">
    </div>
  </div>
</td>
...
<?php    
    ...
    <?php if($getContestant_id==$con_idTab){?>
        <li class="active" ><a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=<?php echo $con_idTab;?>"><strong><?php echo $i.". "; echo $cont_row['fullname']; ?></strong></a></li>
    <?php  }else{  ?>
            <li class="" ><a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=<?php echo $con_idTab;?>"><?php echo $i.". "; echo $cont_row['fullname']; ?></a></li>
                   ...
                   <a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=allTally">View Tally</a>  
                     <?php  } 
                                        ...
                                        <div class="container">
                                          ...
                                          <font size="4">Pageant Management System &middot; &COPY; <?= date ("Y") ?></font>
                                          <hr />
